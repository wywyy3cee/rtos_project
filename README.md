# ОСРВ — Операционная система реального времени (АПС)
...
|----------|-------------------------------------------------------------|
| Андрей Иващенко  | Реализация системных событий (`os.c`, тесты 6–7, 10–11, 13) |
| Егор Аристов    | Реализация PIP (`resource.c`, тесты 4–5, 8, 12)             |
| Владислав Златов   | Ядро ОС: планировщик, диспетчер, тесты 1–3, 9; интеграция   |
